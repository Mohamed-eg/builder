"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[220],{7350:function(e,t,r){r.d(t,{aa:function(){return createUserWithEmailAndPassword},ab:function(){return signInWithEmailAndPassword},o:function(){return getAuth}});var i,n=r(8745),s=r(3991),a=r(6914),o=r(44),l=r(5538);function _prodErrorMap(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}let c=new n.LL("auth","Firebase",_prodErrorMap()),u=new a.Yd("@firebase/auth");function _logError(e,...t){u.logLevel<=a.in.ERROR&&u.error(`Auth (${s.Jn}): ${e}`,...t)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function recachePasswordPolicy(e){let t=_castAuth(e);t._getPasswordPolicyInternal()&&await t._updatePasswordPolicy()}async function createUserWithEmailAndPassword(e,t,r){let i=_castAuth(e),n=handleRecaptchaFlow(i,{returnSecureToken:!0,email:t,password:r,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",signUp),s=await n.catch(t=>{throw"auth/password-does-not-meet-requirements"===t.code&&recachePasswordPolicy(e),t}),a=await UserCredentialImpl._fromIdTokenResponse(i,"signIn",s);return await i._updateCurrentUser(a.user),a}function signInWithEmailAndPassword(e,t,r){return signInWithCredential((0,n.m9)(e),EmailAuthProvider.credential(t,r)).catch(async t=>{throw"auth/password-does-not-meet-requirements"===t.code&&recachePasswordPolicy(e),t})}new WeakMap;let f="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
